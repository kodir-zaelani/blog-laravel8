          ...
          <div class="card">
            <div class="card-header d-flex p-0">
              ...
              <ul class="nav nav-pills ml-auto p-2">
                ...
                <li class="nav-item"><a class="nav-link" href="#tab_5" data-toggle="tab">Youtube</a></li>
            ...
            <div class="card-body">
              <div class="tab-content">
                ...
                <div class="tab-pane" id="tab_2">
                    <form  wire:submit.prevent="update">
                        ...
                        <div class="form-group">
                            ...
                            <textarea wire:model.lazy="instagram_embed"  class="form-control my-editor" placeholder="Instagram Embed" rows="10"></textarea>
                ...
                <div class="tab-pane" id="tab_3">
                    <form  wire:submit.prevent="update">
                        ...
                        <div class="form-group">
                            ...
                            <textarea wire:model.lazy="twitter_embed"  class="form-control my-editor" placeholder="Twitter Embed" rows="10"></textarea>
                            @error('twitter_embed')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="tab-pane" id="tab_5">
                    <form  wire:submit.prevent="update">
                        <div class="form-group">
                            <label for="youtube">URL Youtube Chanel</label>
                            <input 
                            wire:model.lazy="youtube"
                            type="text"
                            
                            class="form-control @error('youtube') is-invalid @enderror" placeholder="Enter a contact youtube">
                            @error('youtube')
                            <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            <label for="youtube_embed">Youtube Chanel Embed </label>
                            <textarea wire:model.lazy="youtube_embed"  class="form-control my-editor" placeholder="Youtube Embed" rows="10"></textarea>
                            @error('youtube_embed')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
