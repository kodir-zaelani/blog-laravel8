                    ...
                    <div class="table-responsive">
                            ...
                            <thead class="text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->title }}
                                        <br><a href="{{ url('') }}/post/detail/{{ $item->slug }}" target="_blank"> link view</td>
                     ...
                     <div class="modal fade" id="modalImportForm" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="modalImportFormLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="modalImportFormLabel">Import Post</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <form action="{{ route('admin.posts.importSave') }}" method="post" enctype="multipart/form-data" >
                                    @csrf
                                    <div class="modal-body">
