        ...
        <form id="post-form" enctype="multipart/form-data"  action="{{ route('admin.settings.update', $setting ) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Slider Status</h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool btn-sm" data-card-widget="collapse" data-toggle="tooltip"
                                title="Collapse">
                                <i class="fas fa-minus"></i></button>
                        ...
                        <div class="card-body text-center">
                            <div class="mr-2 form-check d-inline">
                                <input {{$setting->status_slider == 1 ? "checked" : ""}} value= 1 
                                class="form-check-input" type="radio" id="status_slider" name="status_slider">
                                <label for="status_slider" class="form-check-label">Active</label>
                            </div>
                            <div class="form-check d-inline">
                                <input {{$setting->status_slider == 0 ? "checked" : ""}} value= 0 
                                class="form-check-input" type="radio" id="status_slider" name="status_slider">
                                <label for="status_slider" class="form-check-label">Inactive</label>
                            </div>
                        </div>
                    </div>
